...
<template>
    ...
    <v-stepper v-model="step" bg-color="blue-grey-darken-4">
      <template v-slot:default="{ prev, next }">
        <v-stepper-header>
            <v-stepper-item editable value="1" icon="mdi-arrow-up">
                    World & Character
                </v-stepper-item>

                <v-divider></v-divider>

                <v-stepper-item editable value="2">World elements</v-stepper-item>

                <v-divider></v-divider>

                <v-stepper-item value="3" editable>Story elements</v-stepper-item>
                ...
                <div class="w-1/3 flex flex-col gap-8">
                    ...
                    <div class="w-full">
                        ...
                        <Popper placement="right" class="dark">
                            ...
                            <textarea id="description" spellcheck="disable" v-model="adventure.worldDescription" @input="generateWorldPreview" class="user-input"
